...
with open('ML//dictionaries//input_dict.json', 'r') as fp:
    input_dict = json.load(fp)
with open('ML//dictionaries//target_dict_r.json', 'r') as fp:
    target_dict_r = json.load(fp)
encoder_model = tf.keras.models.load_model('ML//saved_models//encoder.h5')
decoder_model = tf.keras.models.load_model('ML//saved_models//decoder.h5')
